...
const inputCls = "w-full px-3 py-2 bg-white border border-[rgba(124,58,237,0.1)] text-foreground text-sm outline-none";
...
export function ProductProfileForm({ app, onSave }: Props) {
  ...
  return (
    <div className="space-y-6">
      {/* Metadata */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">Metadata</h3>
      ...
      {/* Product Overview */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">1. Product Overview</h3>
      ...
      {/* Features */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">2. Features & Capabilities</h3>
      ...
      {/* Business Rules */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">3. Business Rules</h3>
      ...
      {/* User Roles */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">4. User Roles & Permissions</h3>
      ...
      {/* User Journeys */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">5. User Journeys</h3>
        <div className="space-y-3">
      ...
      {/* Integrations */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">6. Integrations</h3>
      ...
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">7. Third-Party Services</h3>
      ...
      {/* Support */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">8. Support & Troubleshooting</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Configuration */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">9. Configuration & Flags</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Key Contacts */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">10. Key Contacts</h3>
      ...
      {/* Handover Notes */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">11. Handover Notes</h3>
        <div className="space-y-3">
      ...
      {/* Sign-off */}
      <div className="p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
        <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">Sign-off</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      <div className="flex justify-end pt-4 border-t border-[rgba(124,58,237,0.1)]">
        <button onClick={() => onSave(d)} className="flex items-center gap-2 px-6 py-2 bg-[#7C3AED] text-[#020617] font-medium hover:bg-[#6D28D9]">
...
function F({ label, value, onChange, placeholder, disabled }: { label: string; value: string; onChange?: (v: string) => void; placeholder?: string; disabled?: boolean }) {
  return (
    <div>
      ...
      <input type="text" value={value} onChange={e => onChange?.(e.target.value)} placeholder={placeholder} disabled={disabled} className="w-full px-3 py-2 bg-white border border-[rgba(124,58,237,0.1)] text-foreground text-sm outline-none disabled:opacity-60" />
    </div>
  );
}
...
function TextArea({ label, value, onChange }: { label: string; value: string; onChange: (v: string) => void }) {
  return (
    <div>
      <label className="block text-xs text-muted-foreground mb-1">{label}</label>
      <textarea value={value} onChange={e => onChange(e.target.value)} rows={3} className="w-full px-3 py-2 bg-white border border-[rgba(124,58,237,0.1)] text-foreground text-sm outline-none resize-none" />
    </div>
  );
}
...
function TableHeader({ labels }: { labels: string[] }) {
  return (
    <div className="flex gap-2 mb-1">
      {labels.map((l, i) => <span key={i} className="flex-1 text-[10px] text-muted-foreground uppercase tracking-wider px-2">{l}</span>)}
      <span className="w-8" />
    </div>
  );
}
...
function TableRow({ total, onRemove, children }: { total: number; children: React.ReactNode; onRemove: () => void }) {
  return (
    <div className="flex gap-2 items-center mb-1.5">
      {children}
      {total > 1 ? (
        <button onClick={onRemove} className="flex-shrink-0 p-1 text-muted-foreground hover:text-[#7C3AED]"><Trash2 className="w-3.5 h-3.5" /></button>
      ) : <span className="w-8" />}
    </div>
  );
}
...
function AddBtn({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="flex items-center gap-1 text-xs text-[#7C3AED] hover:underline mt-1"><Plus className="w-3 h-3" /> Add Row</button>
  );
}