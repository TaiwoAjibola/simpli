...
export function DefectBulkCreateModal({ onClose, appId }: DefectBulkCreateModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-12 bg-[rgba(0,0,0,0.7)] overflow-y-auto">
      <div className="w-full max-w-4xl bg-[#020617] border border-[rgba(124,58,237,0.1)] p-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold text-foreground">Bulk Add Defects</h2>
        ...
        {/* Common fields */}
        <div className="mb-6 p-4 bg-[#0F172A] border border-[rgba(124,58,237,0.1)]">
          <h3 className="text-sm font-medium text-foreground mb-3">Common Fields (applies to all)</h3>
          <div className="grid grid-cols-4 gap-4">
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1">Issue Type</label>
              <select
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1">Reproducibility</label>
              <select
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-foreground">Defects</h3>
            <button
              onClick={addRow}
              className="flex items-center gap-1 px-3 py-1.5 bg-white border border-[rgba(124,58,237,0.1)] text-[#7C3AED] text-sm hover:bg-[rgba(124,58,237,0.05)]"
            >
                  ...
                  <tr key={index}>
                    <td className="py-1.5 pr-2">
                      <input
                        ...
                        className="w-full px-2 py-1.5 bg-white border border-[rgba(124,58,237,0.1)] text-foreground text-sm outline-none"
                      />
                    </td>
                    ...
                    <td className="py-1.5 pl-2 text-right">
                      {rows.length > 1 && (
                        <button
                          ...
                          className="p-1 text-muted-foreground hover:text-[#7C3AED]"
                        >
        ...
        <div className="flex items-center justify-between pt-4 border-t border-[rgba(124,58,237,0.1)]">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-[#0F172A] text-foreground border border-[rgba(124,58,237,0.1)] hover:bg-white"
            >
              Cancel
            </button>
            <button
