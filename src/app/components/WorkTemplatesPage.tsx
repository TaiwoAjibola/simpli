    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Reusable task, action point, and defect templates.</p>
        </div>
        {canManage && (
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {workTemplates.map(t => (
          <div key={t.id} className="bg-white border border-[rgba(124,58,237,0.1)] p-4 rounded-lg">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="font-medium text-foreground">{t.name}</h3>
                <p className="text-xs text-muted-foreground capitalize">{t.workKind.replace('_', ' ')}</p>
              </div>
              <div className="flex gap-1">
                ...
                <button
                  ...
                  className="p-1.5 text-muted-foreground hover:bg-[rgba(124,58,237,0.1)] rounded"
                  title="Copy title"
                >
                ...
                {canManage && (
                  <button
                    ...
                    className="p-1.5 text-muted-foreground hover:text-[#ef4444] rounded"
                    title="Delete"
                  >
