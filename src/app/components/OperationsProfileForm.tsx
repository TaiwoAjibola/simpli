...
export function OperationsProfileForm({ app, onSave }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Infrastructure */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">1. Infrastructure</h3>
      ...
      {/* Deployment */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">2. Deployment</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Config & Secrets */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">3. Configuration & Secrets</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Monitoring */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">4. Monitoring & Alerting</h3>
      ...
      {/* Logging */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">5. Logging</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Backup & DR */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">6. Backup & Disaster Recovery</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Incident Response */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">7. Incident Response</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Access Management */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">8. Access Management</h3>
      ...
      {/* Maintenance */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">9. Maintenance</h3>
        <div className="grid grid-cols-2 gap-4">
      ...
      {/* Runbooks */}
      <div className="p-4 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
        <h3 className="text-sm font-semibold text-[#f0f0f5] uppercase tracking-wider mb-4">10. Runbooks</h3>
