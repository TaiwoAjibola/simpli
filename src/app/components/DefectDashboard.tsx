  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#f0f0f5] mb-2">Defect Tracker</h1>
          <p className="text-[#6b6b80]">Track bugs, issues, and QA observations</p>
        </div>
      ...
      {!selectedAppId && (
        <div className="text-center py-12 bg-[#12121a] border border-[rgba(0,229,255,0.1)]">
          <Bug className="w-16 h-16 text-[#6b6b80] mx-auto mb-4" />
          <p className="text-[#6b6b80]">Select an app to view defects</p>
        </div>
      )}
      ...
      {selectedAppId && (
        <>
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#f0f0f5]">{metrics.total}</p>
                  <p className="text-sm text-[#6b6b80]">Total Defects</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#f0f0f5]">{metrics.open + metrics.inProgress}</p>
                  <p className="text-sm text-[#6b6b80]">Open Defects</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#f0f0f5]">{metrics.closed}</p>
                  <p className="text-sm text-[#6b6b80]">Resolved</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#f0f0f5]">{metrics.resolutionRate}%</p>
                  <p className="text-sm text-[#6b6b80]">Resolution Rate</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="bg-[#12121a] border border-[rgba(153,27,27,0.2)] p-4">
              <div className="flex items-center gap-3">
                <AlertTriangle className="w-5 h-5 text-[#991b1b]" />
                <div>
                  <p className="text-xl font-bold text-[#dc2626]">{metrics.blockers}</p>
                  <p className="text-sm text-[#6b6b80]">Blockers</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(220,38,38,0.2)] p-4">
              <div className="flex items-center gap-3">
                <AlertTriangle className="w-5 h-5 text-[#dc2626]" />
                <div>
                  <p className="text-xl font-bold text-[#dc2626]">{metrics.critical}</p>
                  <p className="text-sm text-[#6b6b80]">Critical</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(139,92,246,0.2)] p-4">
              <div className="flex items-center gap-3">
                <RefreshCw className="w-5 h-5 text-[#8b5cf6]" />
                <div>
                  <p className="text-xl font-bold text-[#8b5cf6]">{metrics.pendingQA}</p>
                  <p className="text-sm text-[#6b6b80]">Pending QA</p>
                </div>
              </div>
            </div>
            <div className="bg-[#12121a] border border-[rgba(239,68,68,0.2)] p-4">
              <div className="flex items-center gap-3">
                <XCircle className="w-5 h-5 text-[#ef4444]" />
                <div>
                  <p className="text-xl font-bold text-[#ef4444]">{metrics.reopened}</p>
                  <p className="text-sm text-[#6b6b80]">Reopened</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <h3 className="text-sm font-medium text-[#f0f0f5] mb-4">Severity Distribution</h3>
                  ...
                  return (
                    <div key={sev}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-[#f0f0f5] capitalize">{sev}</span>
                        <span className="text-[#6b6b80]">{count}</span>
                      </div>
            ...
            <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] p-4">
              <h3 className="text-sm font-medium text-[#f0f0f5] mb-4">Status Distribution</h3>
              <div className="space-y-3">
                {(['open', 'in_progress', 'pending_qa', 'resolved', 'closed'] as DefectStatus[]).map(status => {
                  ...
                  return (
                    <div key={status}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-[#f0f0f5] capitalize">{status.replace('_', ' ')}</span>
                        <span className="text-[#6b6b80]">{count}</span>
                      </div>
                      <div className="h-2 bg-[#1a1a2e] rounded-full overflow-hidden">
                        <div
          ...
          <div className="bg-[#12121a] border border-[rgba(0,229,255,0.1)] mb-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-[#1a1a2e] border border-[rgba(0,229,255,0.1)] text-[#f0f0f5] text-sm focus:ring-2 focus:ring-[#00e5ff] focus:border-transparent outline-none"
                  />
                </div>
                <select
                  value={filterStatus}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[rgba(0,229,255,0.1)]">
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">ID</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Title</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Module</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Severity</th>
                    ...
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Reporter</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Due Date</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Verified</th>
                    <th className="text-left py-3 px-4 text-[#6b6b80] font-medium">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredDefects.length === 0 && (
                    <tr>
                      <td colSpan={10} className="py-8 text-center text-[#6b6b80]">
                        No defects found
                      </td>
                    </tr>
                  )}
                  {filteredDefects.map(defect => (
                    <tr key={defect.id} className="border-b border-[rgba(0,229,255,0.05)] hover:bg-[rgba(255,255,255,0.02)]">
                      <td className="py-3 px-4">
                        <span className="font-mono text-xs text-[#00e5ff]">{defect.defectCode}</span>
                      </td>
                      <td className="py-3 px-4">
                        <span className="text-[#f0f0f5] font-medium">{defect.title}</span>
                      </td>
                      <td className="py-3 px-4 text-[#6b6b80]">{defect.module}</td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4 text-[#f0f0f5]">{getEmployeeName(defect.assignedTo)}</td>
                      <td className="py-3 px-4 text-[#6b6b80]">{getEmployeeName(defect.reportedBy)}</td>
                      <td className="py-3 px-4 text-[#6b6b80]">
                      ...
                      <td className="py-3 px-4">
                        {defect.fixVerified ? (
                          ...
                          <XCircle className="w-4 h-4 text-[#6b6b80]" />
                        )}
                      </td>
                      <td className="py-3 px-4">
